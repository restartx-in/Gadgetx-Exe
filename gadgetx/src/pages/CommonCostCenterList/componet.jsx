...
import { useSearchParams } from "react-router-dom"; // Assumed import
...
const CommonCostCenterList = ({
  ...
  const addBtnText = "Add Cost Center";
  const tableHeaders = ["Name"];
  const TABLE_CAPTION = CRUDITEM.COSTCENTER;
  ...
  useEffect(() => {
    ...
    // NOTE: handleCloseModal is intentionally omitted from dependencies to avoid infinite loop
  ...
  return (
    <>
      ...
      <AddCostCenterModal
        ...
        mode={mode}
        selectedCostCenter={selectedItem}
      />
    </>
  );
};
