...
const DRAFT_KEY = "done_by_form_draft";

// 1. Define Zod Schema
const doneBySchema = z.object({
  name: z.string().min(1, "Name is required"),
});

const CommonDoneByModal = ({
  useCreateHook,
  useUpdateHook,
  useDeleteHook,
  isOpen,
  ...
  const ENTITY_NAME = CRUDITEM.DONEBY || "Done By";
  ...
  const { control, handleSubmit, reset, watch, setFocus } = useForm({
    resolver: zodResolver(doneBySchema),
    defaultValues,
  });
