...
const ServiceList = () => {
  ...
  const handleRefresh = () =>
    setState({ page: 1, searchKey: "", status: "", customer_name: "", sort: "-created_at" });
        ...
        mainActions={
          <>
            ...
            <PopupSearchField
              ...
              setSearchType={(v) => setUiState({ ...uiState, searchType: v })}
                    ...
                    <ThFilterContainer>
                      ...
                      >
                        <InputField
                          ...
                          onKeyDown={(e) =>
                            e.key === "Enter" && onHeaderSearch("customer_name")
                          }
                        />
                      </ThSearchOrFilterPopover>
                    </ThFilterContainer>
                  ...
                  <Tr key={item.id}>
                    ...
                    <Td>
                      <div style={{ fontSize: "12px", color: "#666" }}>
                        <strong>Issue:</strong> {item.issue_report || item.description}
                      </div>
                      {item.service && (
                    ...
                    <Td>
                      <span
                        style={{
                          ...
                          color:
                            item.status === "completed" ? "#166534" : "#854d0e",
                        }}
                      >
                    ...
                    <Td>
                      <span
                        style={{
                          fontSize: "11px",
                          color: item.service_charge_status === "paid" ? "#059669" : "#dc2626",
                          fontWeight: 500
                        }}
                      >
                        {(item.service_charge_status || "unpaid").toUpperCase()}
                      </span>
                    </Td>
                    <Td>
                      <div style={{ fontWeight: 700, color: (item.service_charge - item.cost) >= 0 ? "#059669" : "#dc2626" }}>
                        <AmountSymbol>{(item.service_charge || 0) - (item.cost || 0)}</AmountSymbol>
                      </div>
                    </Td>
