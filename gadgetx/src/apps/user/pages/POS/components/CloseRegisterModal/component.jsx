...
import useCloseRegisterSession from "@/apps/user/hooks/api/registerSession/useCloseRegisterSession";
import useRegisterSessionById from "@/apps/user/hooks/api/registerSession/useRegisterSessionById";
...
const CloseRegisterModal = ({
  ...
  const { data: sessionData, isLoading: isFetchingStats, refetch: refetchSessionStats } =
    useRegisterSessionById(sessionId);
  ...
  }, [isOpen, sessionId, refetchSessionStats]);
    ...
    >
      ...
      <ModalBody className="register-modal__body">
        {isFetchingStats ? (
          ...
          <>
            <p
              className="modal-instruction fs16"
              style={{ fontSize: "1.05rem", marginBottom: "15px" }}
            >
              Session:{" "}
              {sessionData?.session?.opened_at &&
                new Date(sessionData.session.opened_at).toLocaleString()}
            </p>
            ...
            >
              ...
              >
                ...
                <strong>
                  <AmountSymbol>
                    {sessionData?.session?.opening_cash || 0}
                  </AmountSymbol>
                </strong>
              </div>
              <div
              ...
              >
                ...
                <span className="fs12">
                  <AmountSymbol>{stats.sales_total || 0}</AmountSymbol>
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span className="fs12">
                  <AmountSymbol>{stats.sale_return_total || 0}</AmountSymbol>
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span className="fs12">
                  <AmountSymbol>{stats.purchase_total || 0}</AmountSymbol>
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span className="fs12">
                  <AmountSymbol>{stats.cash_in || 0}</AmountSymbol>
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span className="fs12">
                  <AmountSymbol>{stats.cash_out || 0}</AmountSymbol>
                </span>
              </div>
              ...
              >
                ...
                <span className="fs12">
                  <AmountSymbol>{expectedCash}</AmountSymbol>
                </span>
              </div>
            </div>
            ...
            <div className="form-group fs14">
              <InputField
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, closing_cash: e.target.value }))
                }
              ...
              <InputField
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, closing_note: e.target.value }))
                }
              />
            </div>
          </>
