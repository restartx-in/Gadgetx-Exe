...
const PaymentReport = () => {
  ...
  const [state, setState] = useReducer(stateReducer, {
    ...
    voucher_type: 0, // Payment Vouchers
    invoice_types: searchParams.get("invoiceTypes") || "PURCHASE,SALERETURN",
  });

  // Local UI state for form inputs to prevent API calls on every keystroke
  ...
  // Sync local UI states when main state changes (e.g., from URL on initial load or back button)
  useEffect(() => {
