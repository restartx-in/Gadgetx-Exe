...
import { usePurchaseReturnInvoiceNextNo } from "@/apps/user/hooks/api/purchaseReturnInvoiceNo/usePurchaseReturnInvoiceNextNo";
export function useCreatePurchaseReturn() {
  ...
  return useMutation({
    ...
    onSuccess: (response) => {
       queryClient.setQueriesData({ queryKey: ["purchaseReturns"] }, (oldData) => {
